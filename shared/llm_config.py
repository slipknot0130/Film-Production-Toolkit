...
# =============================================================================
# 模型说明与价格提示（侧栏展示用，辅助选型）
# =============================================================================
# 与 MODEL_OPTIONS 配合：侧栏选中模型后显示其容量 / 价格 / 定位。
# 价格口径：元 / 百万 tokens（2026-09 DeepSeek 官方定价页）。

MODEL_INFO: Dict[str, str] = {
    "deepseek-flash":
        "V4.1-Flash｜1M 上下文 · 输出上限 384K｜"
        "输出 ¥4/百万tokens（平峰）· ¥8（高峰）｜便宜快，日常首选",
    "deepseek-v4-pro":
        "V4-Pro-0813｜1M 上下文 · 输出上限 384K｜"
        "输出 ¥13.5/百万tokens（平峰）· ¥27（高峰）｜质量更强，关键环节用",
}

# 服务商级提示（价格政策等；未列出的服务商不显示）
PROVIDER_NOTES: Dict[str, str] = {
    "DeepSeek":
        "分时计价：工作日 9:00-12:00、14:00-18:00 为高峰，其余时段为平峰（价格减半）",
}
